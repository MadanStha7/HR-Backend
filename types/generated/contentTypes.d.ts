...
export interface ApiCheckInCheckIn extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    date: Attribute.Date;
    check_in: Attribute.Time;
    check_out: Attribute.Time;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    designation: Attribute.String & Attribute.Unique;
    address: Attribute.String & Attribute.Unique;
    full_name: Attribute.String & Attribute.Unique;
    user_role: Attribute.String;
    join_date: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'plugin::users-permissions.user',
